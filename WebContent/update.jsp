	...
	<div class="container">
		...
		<form method="post"  action="updateAction.jsp?bbsID=<%=bbsID%>">
			<table class="table table-striped" style="text-align: center; border:1px solid #dddddd" >
				<thead>
					<tr>
						<th colspan="2" style="background-color: #aaaaaa; text-align: center;">掲示板 内容
					</tr>
				</thead>
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="タイトル" name="bbsTitle" maxlength="50"
			...
			<input type="submit" class="btn btn-primary pull-right" value="内容修正">
			</form>
		</div>
	</div>
